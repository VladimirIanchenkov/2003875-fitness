...
/* harmony import */ var _modules_tab__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/tab */ "./js/modules/tab.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  // Modules
  // ---------------------------------
  Object(_modules_video_player__WEBPACK_IMPORTED_MODULE_2__["initVideo"])();
  Object(_modules_tab__WEBPACK_IMPORTED_MODULE_3__["initTabs"])();
...
var carouselContainer = document.querySelector('.reviews__carousel');
carouselContainer.classList.remove('reviews__carousel--nojs');
var initCarousel = new Swiper('.reviews__carousel', {
  loop: false,
  slidesPerView: 1,
  centeredSlides: true,
  initialSlide: 0,
...
var initTabs = function initTabs() {
  ...
  var head = document.querySelector('.tab__head'); // ищем элемент с кнопками и записываем в константу
  var body = document.querySelector('.tab__body'); // ищем элемент с контентом и записываем в константу
  ...
  var setActiveContent = function setActiveContent() {
    ...
    if (body.querySelector('.tab__content-list--active')) {
    ...
    body.querySelector("[data-tab=".concat(getActiveTabName(), "]")).classList.add('tab__content-list--active'); // затем ищем элемент контента, у которого значение data-tab совпадает со значением data-tab активной кнопки и отображаем его
  };

  // проверяем при загрузке страницы, есть ли активная вкладка
  if (!head.querySelector('.tab__link--active')) {
  ...
  head.addEventListener('click', function (evt) {
    ...
    var caption = evt.target.closest('.tab__link'); // узнаем, был ли клик на кнопке
    if (!caption || caption.classList.contains('tab__link--active')) {
      return;
    } else
      // если клик был не на кнопке, то прерываем выполнение функции // если клик был на активной кнопке, то тоже прерываем выполнение функции и ничего не делаем
...
var videoFrame = document.querySelector('.gym__video');
var ytFrame = document.querySelector('.gym__video-player');
var videoPlaceholder = document.querySelector('.gym__video-placeholder');
var videoButton = document.querySelector('.gym__video-button');
var initVideoFrame = function initVideoFrame() {
